export const listItem =
  'text-white cursor-pointer font-bold px-1.5 py-1 rounded-md duration-200 hover:bg-white hover:text-black';

export const spectacularTitle = 'text-6xl font-bold';
