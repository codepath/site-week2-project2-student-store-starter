...
export default function ProductView({product, productId, handleAddItemToCart, handleRemoveItemToCart, shoppingCart}) {
    ...
    return (<div className="product-view">
        ...
        <ProductCard product={product} showDescription={true} handleAddItemToCart={handleAddItemToCart} handleRemoveItemToCart={handleRemoveItemToCart} shoppingCart={shoppingCart}></ProductCard>
    </div>);
}