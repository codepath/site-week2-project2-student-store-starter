...
export default function Home(props) {
  return (
    <div className="home">
      ...
      <SubNavbar products={props.products} setProducts={props.setProducts} searchFormContent={props.searchFormContent} setSearchFormContent={props.setSearchFormContent} ></SubNavbar>
      ...
      setSearchFormContent={props.setSearchFormContent}>Product Grid</ProductGrid>
