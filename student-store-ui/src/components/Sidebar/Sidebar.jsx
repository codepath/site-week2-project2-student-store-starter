  ...
  return (
    <section className={`sidebar ${props.isOpen ? `open` : `closed`}`}>
      <div className="sidebar-wrapper">
        ...
        <ShoppingCart setIsOpen={props.setIsOpen} order={props.order} getReceipt={props.getReceipt} setGetReceipt={props.setGetReceipt} checkoutError={props.checkoutError} checkoutForm={props.checkoutForm} handleOnCheckoutFormChange={props.handleOnCheckoutFormChange} handleOnSubmit={props.handleOnSubmitCheckoutForm} products={props.products} isOpen={props.isOpen} shoppingCart={props.shoppingCart}/>
      </div>
    </section>
  )
}
